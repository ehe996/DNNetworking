...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hejunhe/DNNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hejunhe' => '928510851@qq.com' }
  s.source           = { :git => 'https://github.com/hejunhe/DNNetworking.git', :tag => s.version.to_s }
